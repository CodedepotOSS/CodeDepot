...
<td class="nav-text-page-name"><nobr><span style="font-size: 80%; padding-left: 1em;"></span></nobr></td>
...
<%}%>
<td class="nav-backgroud nav-text-menu-disabled"><nobr>アカウント管理</nobr></td>
